...
class KlikDoctorController extends Controller
{
    ...
    public function index()
    {
        ...
        //Spesialis
        $allSpesialis = Spesialis::all();
        return view('klik-doctor.index',compact('allDokter','allRS','allKotaRS','allSpesialis'));
    }
    ...
    public function detailDoctor($id)
    {
        ...
        return view('klik-doctor.detail_doctor',compact('getDokter'));
    }
}
